...
// AI Translation Provider Icons (paths relative to extension root)
export const OPENAI_LOGO_PATH: string = "icons/openai.svg";
export const ANTHROPIC_LOGO_PATH: string = "icons/anthropic.svg";
export const GEMINI_LOGO_PATH: string = "icons/gemini.svg";
...
export const LOG_PREFIX_AI_TRANSLATION: string = "[BetterLyrics:AITranslation]";
